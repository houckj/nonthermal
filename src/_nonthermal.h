...
#define KEV  (1.e3 * GSL_CONST_CGSM_ELECTRON_VOLT)
#define MEV  (1.e6 * GSL_CONST_CGSM_ELECTRON_VOLT)
#define GEV  (1.e9 * GSL_CONST_CGSM_ELECTRON_VOLT)
#define TEV  (1.e12 * GSL_CONST_CGSM_ELECTRON_VOLT)

#define BARN        (1.e-24)
#define MILLIBARN   (1.e-27)
...
#define PIZERO_REST_ENERGY  (135.0 * MEV)
